...
const DEMO_USERS: Record<UserRole, AppUser> = {
  ...
  player: { id: 'p1', name: 'Chukwuemeka Obi', email: 'emeka@lfc.ng', role: 'player', teamId: '1', playerId: '1' },
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AppContext.Provider value={{ user, role, isAuthenticated: !!user, isLoading, login, loginAsRole, logout, setUser }}>
      {children}
    </AppContext.Provider>
  );
}
